...
public class AncientDigSiteStructure extends StructureFeature<JigsawConfiguration> {
    ...
    private static boolean isFeatureChunk(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        return !context.chunkGenerator().hasFeatureChunkInRange(BuiltinStructureSets.BURIED_TREASURES, context.seed(), chunkpos.x, chunkpos.z, 10);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            //ModestMining.LOGGER.log(Level.DEBUG, "Ancient Dig Site Structrues at {}", blockpos);
        }
